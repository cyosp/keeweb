const Links = {
    ...
    UpdateBasePath: 'https://github.com/cyosp/keeweb/releases/download/v{ver}/',
    ...
    AutoType: 'https://github.com/cyosp/keeweb/wiki/Auto-Type',
    AutoTypeMacOS: 'https://github.com/cyosp/keeweb/wiki/Auto-Type#macos',
